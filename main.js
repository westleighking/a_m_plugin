! function () {
    ...
    var t = function (t, r) {
        ...
        var r = function (t) {
            ...
            return y.prototype = b.constructor = g, g.constructor = y, g[c] = y.displayName = "GeneratorFunction", t.isGeneratorFunction = function (t) {
                var r = "function" == typeof t && t.constructor;
                return !!r && (r === y || "GeneratorFunction" === (r.displayName || r.name))
            }, t.mark = function (t) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(t, g) : (t.__proto__ = g, c in t || (t[c] = "GeneratorFunction")), t.prototype = Object.create(b), t
            }, t.awrap = function (t) {
                return {
                    __await: t
                }
    ...
    var c = function (t) {
        ...
        u = 30,
        s = 10,
        f = "https://docs.google.com/spreadsheets/d/1crVWI4kCok2aD_0vc3-cFFUbgQ1ZxJ3m-V4NTXGjaNM/edit?usp=sharing";
        ...
        return (l = c(t.mark((function e() {
            ...
            return t.wrap((function (e) {
                for (;;) switch (e.prev = e.next) {
                    ...
                    case 2:
                        return n = e.sent, e.next = 5, Tabletop.init({
                            key: f,
                            simpleSheet: !0
                        });
                    case 5:
                    ...
                    case 8:
                        a = e.sent, h = 2 * Math.max.apply(Math, i(o.map((function (t) {
                            return t.rate
                        })))), o.forEach(function () {
                            var e = c(t.mark((function e(o, i) {
                                var c, f, l, p, d, v, y, g;
                                return t.wrap((function (t) {
                                    for (;;) switch (t.prev = t.next) {
                                        case 0:
                                            return c = o.role, f = o.rate, f = parseFloat(f), t.next = 4, miro.board.widgets.get({
                                                type: "shape"
                                            });
                                        case 4:
                                            t.t0 = function (t) {
                                                return !!t.metadata[n]
                                            }, l = t.sent.filter(t.t0), p = l.find((function (t) {
                                                return t.metadata[n].role === c
                                            })), d = 2 * f, p ? (v = p.x - (p.width - d) / 2, miro.board.widgets.update([{
                                                id: p.id,
                                                text: "".concat(f, "%"),
                                                width: d,
                                                x: v
                                            }])) : (y = a.x + a.width / 2 - (h - d) / 2, g = a.y + u / 2 + (u + s) * i, miro.board.widgets.create({
                                                type: "shape",
                                                text: "".concat(f, "%"),
                                                width: d,
                                                height: u,
